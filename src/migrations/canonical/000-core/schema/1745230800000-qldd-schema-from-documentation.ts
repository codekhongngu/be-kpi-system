...
export class QLDLSchemaFromDocumentation1745230800000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      VALUES
        ('kinh_te', 'Kinh tế', 'Nhóm lĩnh vực kinh tế cấp xã', 10, true, now()),
        ('van_hoa_xa_hoi', 'Văn hóa - Xã hội', 'Nhóm lĩnh vực văn hóa, giáo dục, y tế, an sinh', 20, true, now()),
        ('hanh_chinh', 'Hành chính', 'Nhóm lĩnh vực hành chính, cải cách thủ tục', 30, true, now()),
        ('tai_chinh', 'Tài chính', 'Nhóm lĩnh vực ngân sách, thu - chi, kế toán', 40, true, now()),
        ('dat_dai_moi_truong', 'Đất đai - Môi trường', 'Nhóm lĩnh vực đất đai, tài nguyên, môi trường', 50, true, now()),
        ('an_ninh_quoc_phong', 'An ninh - Quốc phòng', 'Nhóm lĩnh vực quốc phòng, an ninh, trật tự', 60, true, now()),
        ('tu_phap', 'Tư pháp', 'Nhóm lĩnh vực hộ tịch, chứng thực, pháp chế', 70, true, now()),
        ('khieu_nai_tiep_dan', 'Khiếu nại - Tiếp dân', 'Nhóm lĩnh vực tiếp công dân, khiếu nại, phản ánh', 80, true, now())
