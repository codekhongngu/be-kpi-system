...
export class V2InitCore1862000000000 implements MigrationInterface {
  name = 'V2InitCore1862000000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "schema_migration_locks" (
        ...
        "lock_key" varchar(120) NOT NULL UNIQUE,
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_outbox_status_next_retry" ON "app_outbox_events" ("status", "next_retry_at")`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_outbox_aggregate" ON "app_outbox_events" ("aggregate_type", "aggregate_id", "created_at" DESC)`);
  }
